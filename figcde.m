...
errorbar(1:4,mean(SignalChose_no,2)',std(SignalChose_no',1)/sqrt(num),'o-','Markersize',15,...
    'MarkerFaceColor',addcolorplus(94),'MarkerEdgeColor',addcolorplus(94),'LineWidth',2,'Color','k');
errorbar(1:4,mean(SignalChose_s,2)',std(SignalChose_s',1)/sqrt(num),'o-','Markersize',15,...
...
ylabel('Rate','FontSize',25);
set(gca,'FontSize',20,'XTick',[1.5 4.5 7.5]);
...
xlabel('AH score','FontSize',25);
set(gca,'FontSize',20,'XTick',1:9);
set(gca,'FontName','c');
xlim([0 8]);
% ylim([-0.15 0.2]);
